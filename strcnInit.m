function net = strcnInit( varargin )
%STRCNNINIT initialize the spatiotemporal deep net based on optical flow
...
opts.classNames = {'negative','positive','surprise'} ;
opts.classDescriptions = {'negative','positive','surprise'}  ;
...
net.addLayer('prediction' , ...
    dagnn.Conv('size', [1 1 opts.maps numel(opts.classNames)]), ...
    'prediction_avg', ...
    'prediction', ...
